...
class _HyperVolume:
    ...
    def compute(self, front):
        ...
        def weaklyDominates(point, other):
            for i in range(len(point)):  #xrange
                if point[i] > other[i]:
                    return False
            return True
    ...
    def hvRecursive(self, dimIndex, length, bounds):
        ...
        if length == 0:
            ...
            if length > 1:
                ...
                qArea[0] = 1
                qArea[1:dimIndex + 1] = [qArea[i] * -qCargo[i] for i in range(dimIndex)]  #xrange
    ...
    def preProcess(self, front):
        ...
        for i in range(dimensions):  #xrange
...
class _MultiList:
    ...
    def __str__(self):
        strings = []
        for i in range(self.numberLists): #xrange
            currentList = []
...
if __name__ == "__main__":
    ...
    pointset = [(a, a) for a in numpy.arange(1, 0, -0.01)]  #1, 0, -0.01
    print("pointset", type(pointset))
